...
.background {
  position: absolute;
  top: 128px; /* Para que no tape la barra de navegación */
  left: 0;
  width: 100vw; /* Asegura que cubra todo el ancho */
  height: calc(100vh - 64px); /* Ocupa toda la pantalla sin tapar el navbar */
  background-image: url('@/assets/coraje.png');
